...
mod.COSTUME_GLUTTONY_BODY = Isaac.GetCostumeIdByPath("gfx/characters/character_l22_gluttony.anm2")
...
function L22_Gluttony:postUpdate()
  ...
  mod:AddCallback(ModCallbacks.MC_POST_PEFFECT_UPDATE, L22_Gluttony.Costume)
